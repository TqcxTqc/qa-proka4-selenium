...
TOP_TRACKS_AREA_BUTTON = ("xpath", "//a[@href='/tracks?category=27']")
DATA_ANALYSIS_BUTTON = ("xpath", "//a[@href='/tracks?category=11']")
CARD_INTRODUCTION_PYTHON_TITLE = ("xpath", "//a[@href='/tracks/6']//h5")
KOTLIN_CORE_CERTIFICATE_LABEL = ("xpath", "//a[@href='/tracks/18']//span[contains(@class,'badge')]")
...
TOPIC_ANDROID = ("xpath", "//a[@href='/tracks?category=22']")
TOPIC_BACKEND = ("xpath", "//a[@href='/tracks?category=19']")
TOPIC_PYTHON = ("xpath", "//a[@href='/tracks?category=1']")
TOPIC_JAVA = ("xpath", "//a[@href='/tracks?category=2']")
...
PRICING_LINK = ("xpath", "//a[@click-event-target='pricing']")
FULL_CATALOG_BUTTON = ("xpath", "//div[contains(@class,'tracks-panel-footer')]//a[@click-event-target='full_catalog']")
...
HELP_CENTER_LINK = ("xpath", "//a[@click-event-target='help-center']")
